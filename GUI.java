...
public class GUI extends JFrame implements ActionListener {
    ...
    public GUI() {
        ...
        arkisto.addListSelectionListener(new ListSelectionListener() {
            ...
            public void valueChanged(ListSelectionEvent e) {
                ...
                if(indexi >= 0) {
                    ...
                    if(p.getTila().equals(aloitettuNappi.getActionCommand())) {
                        aloitettuNappi.doClick();
                    } else if(p.getTila().equals(keskenNappi.getActionCommand())) {
                        keskenNappi.doClick();
                    } else if(p.getTila().equals(pelattuNappi.getActionCommand())) {
                        pelattuNappi.doClick();
                    } else if(p.getTila().equals(pelaan.getActionCommand())) {
                        pelaan.doClick();
                    }
        ...
        aloitettuNappi.setActionCommand("Aloitettu");
        keskenNappi.setActionCommand("Kesken");
        pelattuNappi.setActionCommand("Pelattu");
        pelaan.setActionCommand("Pelaan");
    ...
    public void actionPerformed(ActionEvent x) {
        if(x.getSource()==uusiPeli) {
           ...
           jarjestelmaKentta.setEnabled(true);
            ...
            Peli p = new Peli(nimiKentta.getText(), jarjestelmaKentta.getText(), kommenttiKentta.getText(), ryhmaTila.getSelection().getActionCommand());
            
            if(onkoArkistossa(p)==false) {
            
            pelit.add(p);
            peliLista.addElement(p.getNimi());
            ryhmaTila.clearSelection();
            ...
            if(vastaus == JFileChooser.APPROVE_OPTION) {
                ...
                try {
                    ...
                    while(scan.hasNextLine()) {
                        ...
                        Peli p = new Peli(nimi,jarjestelma,kommentit,tila);
